...
function form(int $num, string $form1, string $form2, string $form3): string {
...
function happyTicket(string $number): string {
...
function getDigitsSum(array $result): int {
...
function friendlyNumbers(int $i, int $j) {
